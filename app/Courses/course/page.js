...
export default function CoursePage() {
    ...
    const [testPres, switchTestPres] = useState(false);
    ...
    return (
      <div className="flex flex-col gap-5 mx-auto w-full max-w-md items-center">
        <div className="p-4">
        ...
        <div className="wt-1 wb-1 border-b-2 border-white w-full flex gap-5 transition-all duration-1000">
          <button 
            className={` text-lg font-semibold pr-2 pl-2 rounded-t-lg transition-colors duration-500 ${testPres ? "" : "bg-white text-black"}`}
            onClick={() => switchTestPres(false)}
          >
            Presentation
          </button>
          <button 
            className={`text-lg font-semibold pr-2 pl-2 rounded-t-lg transition-colors duration-500 ${testPres ? "bg-white text-black" : ""}`}
            onClick={() => switchTestPres(true)}
          >
            Test
          </button>
        </div>
